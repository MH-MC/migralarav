<div class="col-sm-3 col-md-2 sidebar">
  <ul class="nav nav-sidebar">
    <li class="dropdown">
        ...
        <ul id="submenu1" class="nav nav-list {{ Request::is('admin/user') || Request::is('admin/affiliate') || Request::is('admin/adminuser')? 'collapse in' : 'collapse' }}">
          <li class="{{ Request::is('admin/user')? 'active' : '' }}">
            <a href="{{ url('admin/user') }}">Miembros</a>
          </li>
          <li class="{{ Request::is('admin/affliate')? 'active' : '' }}">
            <a href="{{ url('admin/affiliate') }}">Afiliados</a>
          </li>
          <li class="{{ Request::is('admin/adminuser')? 'active' : '' }}">
    ...
    <li class="{{ Request::is('admin/narrator')? 'active' : '' }}">
    ...
    <li class="dropdown">
        ...
        <ul id="submenu2" class="nav nav-list {{ Request::is('admin/audiobook') || Request::is('admin/verify_audiobook')? 'collapse in' : 'collapse' }}">
          <li class="{{ Request::is('admin/audiobook')? 'active' : '' }}">
            <a href="{{ url('admin/audiobook') }}">Listado</a>
          </li>
          <li class="{{ Request::is('admin/verify_audiobook')? 'active' : '' }}">
    ...
    <li class="dropdown">
        ...
        <ul id="submenu3" class="nav nav-list {{ Request::is('admin/contract') || Request::is('admin/contract_model')? 'collapse in' : 'collapse' }}">
          <li class="{{ Request::is('admin/contract')? 'active' : '' }}">
            <a href="{{ url('admin/contract') }}">Listado</a>
          </li>
          <li class="{{ Request::is('admin/contract_model')? 'active' : '' }}">
    ...
    <li class="{{ Request::is('admin/public_biblio')? 'active' : '' }}">
