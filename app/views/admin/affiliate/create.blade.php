...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	...
	<div class="form-group">
		<div class="{{ $errors->has('username')? 'has-error' : (Session::has('errors')? 'has-success' : '') }} ">
			...
			<div class="col-sm-3">
				<input type="text" class="field form-control" id="username" name="username" placeholder="Username" value="{{ Input::old('username') }}" maxlength="25">
		...
		<div class="{{ $errors->has('firstname')? 'has-error' : (Session::has('errors')? 'has-success' : '') }} ">
			...
			<div class="col-sm-3">
				<input type="text" class="field form-control" id="firstname" name="firstname" placeholder="Nombres" value="{{ Input::old('firstname') }}" maxlength="50">
	...
	<div class="form-group">
		<div class="{{ $errors->has('company_name')? 'has-error' : (Session::has('errors')? 'has-success' : '') }} ">
			...
			<div class="col-sm-3">
				<input type="text" class="field form-control" id="company_name" name="company_name" placeholder="Nombre Empresa" value="{{ Input::old('company_name') }}" maxlength="50">
		...
		<div class="{{ $errors->has('position')? 'has-error' : (Session::has('errors')? 'has-success' : '') }} ">
			...
			<div class="col-sm-3">
				<input type="text" class="field form-control" id="position" name="position" placeholder="Posición" value="{{ Input::old('position') }}" maxlength="50">
	...
	<div class="form-group">
		<div class="{{ $errors->has('email')? 'has-error' : (Session::has('errors')? 'has-success' : '') }} ">
			...
			<div class="col-sm-3">
				<input type="email" class="field form-control" id="email" name="email" placeholder="E-mail" value="{{ Input::old('email') }}" maxlength="100">
		...
		<div class="{{ $errors->has('website')? 'has-error' : (Session::has('errors')? 'has-success' : '') }} ">
			...
			<div class="col-sm-3">
				<input type="website" class="field form-control" id="website" name="website" placeholder="Website" value="{{ Input::old('website') }}" maxlength="100">
	...
	<div class="form-group">
		<div class="{{ $errors->has('address')? 'has-error' : (Session::has('errors')? 'has-success' : '') }} ">
			...
			<div class="col-sm-3">
				<textarea class="field form-control" id="address" name="address" placeholder="Dirección" rows="4">{{ Input::old('address') }}</textarea>
		...
		<div class="{{ $errors->has('description')? 'has-error' : (Session::has('errors')? 'has-success' : '') }} ">
			...
			<div class="col-sm-3">
				<textarea class="field form-control" id="description" name="description" placeholder="Descripción" rows="4">{{ Input::old('description') }}</textarea>
